...
const UpdateLocation = () => {
  ...
  const handleManualSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      showPopup("Error finding or updating location. Please check your spelling.", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGPS = async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error(`GPS Error: ${"Please turn on location." || gpsError.message || "Permission denied or unavailable"}`);
      }
  ...
  return (
    <div className="w-full max-w-sm bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-sm p-5">
      ...
      <div className="relative flex items-center py-4">
        ...
        <span className="flex-shrink-0 mx-3 text-xs text-neutral-400 dark:text-neutral-500">OR</span>
        <div className="flex-grow border-t border-neutral-200 dark:border-neutral-800"></div>
      </div>
