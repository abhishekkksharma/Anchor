...
VITE_NEWS_API_KEY = YOUR_NEWS_API
```

### Frontend — `.env`
```env
VITE_CLOUDINARY_CLOUD_NAME=YOUR_CLOUDINARY_DATABASE_NAME
VITE_CLOUDINARY_UPLOAD_PRESET=CLOUDINARY_PRESET
VITE_API_URL=http://localhost:5000

VITE_API_URL_RENDER=YOUR_RENDER_BACKENDURL #ONLY FOR PRODUCTION

# Google OAuth - Replace with your actual Google Client ID from Google Cloud Console
